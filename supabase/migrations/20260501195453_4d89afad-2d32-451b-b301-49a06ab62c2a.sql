-- CHANGE 1a: Lock down EXECUTE permissions
REVOKE EXECUTE ON FUNCTION public.settle_contest_pool_atomic(uuid, uuid) FROM PUBLIC;
REVOKE EXECUTE ON FUNCTION public.settle_contest_pool_atomic(uuid, uuid) FROM authenticated;
REVOKE EXECUTE ON FUNCTION public.settle_contest_pool_atomic(uuid, uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.settle_contest_pool_atomic(uuid, uuid) TO service_role;

-- Apply CHANGES 1b, 2, 3, 4, 5 to function body
