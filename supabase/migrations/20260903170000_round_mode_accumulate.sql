-- Phase 4f-1: round_mode 'accumulate' (Season Accumulator + One & Done).
-- Bases: admin_create_contest_v2 = 20260903060000_confidence_pickem_backend.sql,
-- submit_survivor_round_picks = 20260903042108_same_athlete_guard_reassert.sql,
-- score_survivor_round_atomic = 20260827012112_*.sql (no later redefinition).
