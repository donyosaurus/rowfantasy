-- =====================================================================
-- Phase 4g-A: Confidence Pick'em backend
--   1. admin_create_contest_v2   -> confidence gate (placement/per_race only)
--   2. enter_contest_pool_atomic -> weights must be a 1..k permutation
-- Both bodies are the current repository bodies
-- (20260903052200_roster_tiers_backend.sql) restated verbatim with only the
-- described blocks added. When scoring_config.confidence is absent there is
