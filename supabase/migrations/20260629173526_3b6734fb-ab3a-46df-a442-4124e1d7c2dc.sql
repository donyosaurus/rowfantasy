...
BEGIN
  ...
  -- Qualify current_entries with the table alias to disambiguate from the
  ...
  -- Table-qualify current_entries / max_entries to disambiguate from the OUT columns.
...
REVOKE ALL ON FUNCTION public.enter_contest_pool_atomic(uuid, uuid, uuid, text, jsonb, text) FROM PUBLIC, anon, authenticated;
